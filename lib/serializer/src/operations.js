...
export const airdrop_balance_claim_operation_fee_parameters = new Serializer(
    "airdrop_balance_claim_operation_fee_parameters",
    {fee: uint64}
);
...
export const airdrop_balance_claim = new Serializer(
    "airdrop_balance_claim",
    {fee: asset,
        account_to_deposit: protocol_id_type("account"),
        signature: bytes(65),
        address_type: uint8}
);
